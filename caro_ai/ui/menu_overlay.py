...
class MenuOverlay:
    def __init__(self, screen_width, screen_height):
        ...
        self.btn_ai_first = Button(
            ...
            "AI first", bg_color=(50, 50, 100)
        )

        self.btn_two_players = Button(
            center_x - 125, 410, 250, 60,
            "2 Players", bg_color=(40, 90, 70)
        )

        self.quit_button = Button(
            center_x - 125, 490, 250, 60,
    ...
    def draw(self, screen):
        ...
        self.btn_two_players.draw(screen)
    ...
    def handle_event(self, event):
        ...
        if self.btn_two_players.is_clicked(event):
            return "play_two_players"
